...
exports.Num = void 0;
const NumberTools_1 = require("./NumberTools");
/**
...
class Num {
    ...
    constructor(num) {
        ...
        if (num.base != null && num.base !== 10) {
            ...
            for (let i = 0; i < digits.length; i++) {
                convertedNum += NumberTools_1.DigitToNumber(digits[i]) * Math.pow(this._base, digitsLength - i - 1);
            }
    ...
    Convert(base, precision) {
        ...
        for (let i = digitLog - 1; i > (-1 * precision) - 1; i--) {
            ...
            const digitStr = NumberTools_1.NumberToDigit(number);
        ...
        if (digits.length < digitLog)
            digits.push(..."0".repeat(digitLog - digits.length).split(""));
